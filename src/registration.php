        ...
        <div class="container">
            ...
            <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                ...
                <div class='form-row'>
                    ...
                    <div class='form-group col-md-6'>
                        <label for="password">Mot de passe* : Le mot de passe doit contenir au moins une Majuscule, une minuscule, un chiffre et au moins 8 caractères</label>
                ...
                <div class='form-row'>
                    <div class='form-group col-md-6'>
                        ...
                        {
                            echo '<input id="email1" class="form-control" type="email" name="email" value="' . $_POST["connexionPopupMail"] . '" required/>';
                        } else {
                ...
                <div class='form-row'>
                    ...
                    <div class='form-group col-md-6'>
                        <label for="address2"> Adresse n°2 (Complément: rue, numero, porte,...) : </label>
