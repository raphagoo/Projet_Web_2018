...
<div id="formulairerecherche">
    <form>
        ...
        <h3><label for="format">Format</label></h3>
            ...
            <input type="checkbox" id="acocher" ng-model="moyen" ng-true-value="'13225'" ng-false-value="''" name="format">Moyen (<115x115cm)<br>
...
<script src="angularsi.js" type="text/javascript"></script>
</body>
</html>
